    ...
    return(
        <div>
            <Grid container spacing={2}>
                <Grid item xs={6} sm={6} md={3}><div style={{display:"flex",justifyContent:"center",alignItems:"center"}}> <Link to="/lgcse2" style={{border:"solid",borderRadius:"10px",width:"100%",textDecoration:"none",color:"blue"}}><Button sx={{width:"100%"}}>  LGCSE Paper2  </Button></Link> </div></Grid>
